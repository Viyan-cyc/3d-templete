...
export { Shelf, ShelfComponent, demoJsonDrivenShelf, SHELF_SCENE_DATA_EXAMPLE } from './components'
export { SolarPanel, SolarPanelComponent } from './components'
export type { I3DComponent, ShelfOptions, ShelfCellCoord, SolarPanelOptions } from './components'

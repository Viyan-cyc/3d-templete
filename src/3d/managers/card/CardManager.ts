...
import type { CardDef, CardState, CardStateCallback, CardManagerOptions, CardScanRule, CardScanGroup, CardAnchorSpec } from './types'
  ...
  constructor(options: CardManagerOptions) {
    ...
    this._clickHandler = (e: MouseEvent) => {
      ...
      if (this._pointerDownPos) {
        ...
        if (Math.hypot(dx, dy) > this._clickThreshold) return // 视为拖动，忽略
      }

 ...
 *  const mat = pool.getMaterial("standard:#808080:0.4:1",
 *    () => new THREE.MeshStandardMaterial({ color: "#808080", roughness: 0.4, metalness: 1 }))
 */
export class AssetPool {
  ...
  /** 释放所有缓存资源 */
  dispose(): void {
    for (const geo of this._geos.values()) {
      geo.dispose();
    }
